...
public class FailureResultSetSpellLevel4Values02 {
	...
	static {
		...
		temp.add(Arrays.asList(1, 3));
		temp.add(Arrays.asList(1, 4));
		temp.add(Arrays.asList(1, 5));
		temp.add(Arrays.asList(1, 6));
		temp.add(Arrays.asList(1, 7));
		temp.add(Arrays.asList(1, 8));
		temp.add(Arrays.asList(2, 2));
		temp.add(Arrays.asList(2, 3));
		temp.add(Arrays.asList(2, 4));
		temp.add(Arrays.asList(2, 5));
		temp.add(Arrays.asList(2, 6));
		temp.add(Arrays.asList(2, 7));
	...
	private FailureResultSetSpellLevel4Values02() {
	}
}