...
public class FailureResultSetSpellLevel9Values09 {
	...
	static {
		...
		temp.add(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 1, 7));
		temp.add(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 1, 8));
		temp.add(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 2, 2));
		temp.add(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 2, 3));
		temp.add(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 2, 4));
		temp.add(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 2, 5));
		temp.add(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 2, 7));
		...
		temp.add(Arrays.asList(2, 2, 2, 2, 2, 2, 2, 2, 2));
		EXPECTED_FAILURES = Collections.unmodifiableSet(temp);
	}

	private FailureResultSetSpellLevel9Values09() {
	}
}