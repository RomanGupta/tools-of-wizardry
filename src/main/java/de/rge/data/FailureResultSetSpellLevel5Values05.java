...
public class FailureResultSetSpellLevel5Values05 {
	...
	static {
		...
		temp.add(Arrays.asList(1, 1, 5, 5, 5));
		...
		temp.add(Arrays.asList(2, 2, 8, 8, 8));
		...
		temp.add(Arrays.asList(3, 3, 3, 3, 5));
		temp.add(Arrays.asList(4, 4, 4, 4, 4));
		temp.add(Arrays.asList(4, 4, 4, 8, 8));
		temp.add(Arrays.asList(4, 4, 5, 5, 5));
		temp.add(Arrays.asList(4, 5, 5, 5, 5));
		temp.add(Arrays.asList(4, 8, 8, 8, 8));
		temp.add(Arrays.asList(5, 5, 5, 5, 5));
		temp.add(Arrays.asList(5, 5, 5, 5, 6));
		temp.add(Arrays.asList(8, 8, 8, 8, 8));
		EXPECTED_FAILURES = Collections.unmodifiableSet(temp);
	}

	private FailureResultSetSpellLevel5Values05() {
	}
}