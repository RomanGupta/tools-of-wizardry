...
public class FailureResultSetSpellLevel6Values06 {
	...
	static {
		...
		temp.add(Arrays.asList(1, 3, 3, 3, 3, 3));
		temp.add(Arrays.asList(1, 7, 7, 7, 7, 7));
		...
		temp.add(Arrays.asList(3, 3, 3, 3, 3, 6));
		temp.add(Arrays.asList(5, 5, 5, 5, 5, 5));
		temp.add(Arrays.asList(7, 7, 7, 7, 7, 7));
		temp.add(Arrays.asList(7, 7, 7, 8, 8, 8));
		EXPECTED_FAILURES = Collections.unmodifiableSet(temp);
	}

	private FailureResultSetSpellLevel6Values06() {
	}
}