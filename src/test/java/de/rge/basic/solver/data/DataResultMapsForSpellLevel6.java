...
public class DataResultMapsForSpellLevel6 {
	...
	static {
		...
		temp.put(Arrays.asList(1, 1, 6, 6), FAILURE);
		...
		temp.put(Arrays.asList(1, 2, 4, 6), FAILURE);
		temp.put(Arrays.asList(1, 2, 5, 5), FAILURE);
		temp.put(Arrays.asList(1, 2, 5, 6), SUCCESS); // 1 + 2 * 5 * 6 = 61
		temp.put(Arrays.asList(1, 2, 6, 6), FAILURE);
		...
		temp.put(Arrays.asList(1, 3, 4, 5), SUCCESS); // 1 + 3 * 4 * 5 = 61
		temp.put(Arrays.asList(1, 3, 4, 6), FAILURE);
		temp.put(Arrays.asList(1, 3, 5, 5), FAILURE);
		temp.put(Arrays.asList(1, 3, 5, 6), FAILURE);
		temp.put(Arrays.asList(1, 3, 6, 6), FAILURE);
		temp.put(Arrays.asList(1, 4, 4, 4), FAILURE);
		temp.put(Arrays.asList(1, 4, 4, 5), FAILURE);
		temp.put(Arrays.asList(1, 4, 4, 6), FAILURE);
		temp.put(Arrays.asList(1, 4, 5, 5), FAILURE);
		temp.put(Arrays.asList(1, 4, 5, 6), FAILURE);
		temp.put(Arrays.asList(1, 4, 6, 6), SUCCESS); // 1 + (4 + 6) * 6 = 61
		temp.put(Arrays.asList(1, 5, 5, 5), FAILURE);
		temp.put(Arrays.asList(1, 5, 5, 6), SUCCESS); // 1 + (5 + 5) * 6 = 61
		temp.put(Arrays.asList(1, 5, 6, 6), SUCCESS); // 1 + (5 + 6) * 6 = 67
		temp.put(Arrays.asList(1, 6, 6, 6), FAILURE);
		...
		temp.put(Arrays.asList(2, 3, 4, 5), FAILURE);
		temp.put(Arrays.asList(2, 3, 4, 6), FAILURE);
		temp.put(Arrays.asList(2, 3, 5, 5), FAILURE);
		temp.put(Arrays.asList(2, 3, 5, 6), FAILURE);
		...
		temp.put(Arrays.asList(2, 4, 5, 5), FAILURE);
		temp.put(Arrays.asList(2, 4, 5, 6), FAILURE);
		temp.put(Arrays.asList(2, 4, 6, 6), FAILURE);
		temp.put(Arrays.asList(2, 5, 5, 5), FAILURE);
		temp.put(Arrays.asList(2, 5, 5, 6), FAILURE);
		temp.put(Arrays.asList(2, 5, 6, 6), SUCCESS); // 2 * 6 * 6 - 5 = 67
		...
		temp.put(Arrays.asList(3, 3, 5, 5), FAILURE);
		temp.put(Arrays.asList(3, 3, 5, 6), SUCCESS); // 3 * 3 * 6 + 5 = 59
		temp.put(Arrays.asList(3, 3, 6, 6), FAILURE);
		temp.put(Arrays.asList(3, 4, 4, 4), SUCCESS); // 3 + 4 * 4 * 4 = 67
		temp.put(Arrays.asList(3, 4, 4, 5), FAILURE);
		temp.put(Arrays.asList(3, 4, 4, 6), FAILURE);
		temp.put(Arrays.asList(3, 4, 5, 5), FAILURE);
		temp.put(Arrays.asList(3, 4, 5, 6), SUCCESS); // 3 * 4 * 6 - 5 = 67
		temp.put(Arrays.asList(3, 4, 6, 6), FAILURE);
		temp.put(Arrays.asList(3, 5, 5, 5), FAILURE);
		temp.put(Arrays.asList(3, 5, 5, 6), FAILURE);
		temp.put(Arrays.asList(3, 5, 6, 6), SUCCESS); // 5 + 6 * (3 + 6) = 59
		temp.put(Arrays.asList(3, 6, 6, 6), FAILURE);
		temp.put(Arrays.asList(4, 4, 4, 4), FAILURE);
		temp.put(Arrays.asList(4, 4, 4, 5), SUCCESS); // 4 * 4 * 4 - 5 = 59
		temp.put(Arrays.asList(4, 4, 4, 6), FAILURE);
		temp.put(Arrays.asList(4, 4, 5, 5), FAILURE);
		temp.put(Arrays.asList(4, 4, 5, 6), FAILURE);
		temp.put(Arrays.asList(4, 4, 6, 6), FAILURE);
		temp.put(Arrays.asList(4, 5, 5, 5), FAILURE);
		temp.put(Arrays.asList(4, 5, 5, 6), SUCCESS); // (6 + 5) * 5 + 4 = 59
		temp.put(Arrays.asList(4, 5, 6, 6), FAILURE);
		temp.put(Arrays.asList(4, 6, 6, 6), FAILURE);
		temp.put(Arrays.asList(5, 5, 5, 5), FAILURE);
		temp.put(Arrays.asList(5, 5, 5, 6), FAILURE);
		temp.put(Arrays.asList(5, 5, 6, 6), SUCCESS); // (6 + 5) * 6 - 5 = 61
		temp.put(Arrays.asList(5, 6, 6, 6), SUCCESS); // (6 + 6) * 6 - 5 = 67
		temp.put(Arrays.asList(6, 6, 6, 6), FAILURE);
		EXPECTED_RESULTS_04_VALUES = Collections.unmodifiableMap(temp);
	}

	private DataResultMapsForSpellLevel6() {
	}
}
