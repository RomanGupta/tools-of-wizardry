...
public class DataResultMapsForSpellLevel8 {
	...
	static {
		...
		temp.put(Arrays.asList(1, 2, 5, 6), FAILURE);
		...
		temp.put(Arrays.asList(3, 4, 4, 5), SUCCESS); // 3 + 4 * 4 * 5 = 83
		temp.put(Arrays.asList(3, 4, 4, 6), FAILURE);
		temp.put(Arrays.asList(3, 4, 5, 5), SUCCESS); // 4 * 5 * 5 - 3 = 97
		temp.put(Arrays.asList(3, 4, 5, 6), FAILURE);
