...
public class DataResultMapsForSpellLevel7 {
	...
	static {
		...
		temp.put(Arrays.asList(1, 2, 6, 6), SUCCESS); // 1 + 2 * 6 * 6 = 73
		...
		temp.put(Arrays.asList(1, 3, 4, 6), SUCCESS); // 1 + 3 * 4 * 6 = 73
		...
		temp.put(Arrays.asList(1, 4, 4, 5), SUCCESS); // 4 * 4 * 5 - 1 = 79
		...
		temp.put(Arrays.asList(1, 6, 6, 6), SUCCESS); // 1 + (6 + 6) * 6 = 73
		...
		temp.put(Arrays.asList(2, 3, 5, 5), SUCCESS); // 3 * 5 * 5 - 2 = 73 
		...
		temp.put(Arrays.asList(3, 4, 5, 5), SUCCESS); // 3 * 5 * 5 + 4 = 79
		...
		temp.put(Arrays.asList(5, 5, 6, 6), SUCCESS); // (5 + 6) * 6 + 5 = 71
	...
	private DataResultMapsForSpellLevel7() {
	}
}
