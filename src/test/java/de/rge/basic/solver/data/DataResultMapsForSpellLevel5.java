...
public class DataResultMapsForSpellLevel5 {
	...
	static {
		...
		temp.put(Arrays.asList(1, 1, 4, 6), FAILURE);
		temp.put(Arrays.asList(1, 1, 5, 5), FAILURE);
		temp.put(Arrays.asList(1, 1, 5, 6), FAILURE);
		temp.put(Arrays.asList(1, 1, 6, 6), SUCCESS); // 1 + (1 + 6) * 6 = 43
		...
		temp.put(Arrays.asList(1, 2, 3, 5), FAILURE);
		temp.put(Arrays.asList(1, 2, 3, 6), FAILURE);
		temp.put(Arrays.asList(1, 2, 4, 4), FAILURE);
		temp.put(Arrays.asList(1, 2, 4, 5), FAILURE);
		temp.put(Arrays.asList(1, 2, 4, 6), SUCCESS); // 2 * 4 * 6 - 1 = 47
		temp.put(Arrays.asList(1, 2, 5, 5), FAILURE);
		temp.put(Arrays.asList(1, 2, 5, 6), SUCCESS); // 1 + (2 + 5) * 6 = 43
		temp.put(Arrays.asList(1, 2, 6, 6), SUCCESS); // 6 * (2 + 6) - 1 = 47
		temp.put(Arrays.asList(1, 3, 3, 3), FAILURE);
		temp.put(Arrays.asList(1, 3, 3, 4), FAILURE);
		temp.put(Arrays.asList(1, 3, 3, 5), FAILURE);
		temp.put(Arrays.asList(1, 3, 3, 6), SUCCESS); // 3 * 3 * 6 - 1 = 53
		temp.put(Arrays.asList(1, 3, 4, 4), SUCCESS); // 3 * 4 * 4 - 1 = 47
		temp.put(Arrays.asList(1, 3, 4, 5), FAILURE);
		temp.put(Arrays.asList(1, 3, 4, 6), SUCCESS); // 1 + (3 + 4) * 6 = 43
		temp.put(Arrays.asList(1, 3, 5, 5), FAILURE);
		temp.put(Arrays.asList(1, 3, 5, 6), SUCCESS); // 6 * (3 + 5) - 1 = 47
		temp.put(Arrays.asList(1, 3, 6, 6), SUCCESS); // 6 * (3 + 6) - 1 = 53
		temp.put(Arrays.asList(1, 4, 4, 4), FAILURE);
		temp.put(Arrays.asList(1, 4, 4, 5), FAILURE);
		temp.put(Arrays.asList(1, 4, 4, 6), SUCCESS); // 6 * (4 + 4) - 1 = 47
		temp.put(Arrays.asList(1, 4, 5, 5), FAILURE);
		temp.put(Arrays.asList(1, 4, 5, 6), SUCCESS); // 6 * (4 + 5) - 1 = 53
		temp.put(Arrays.asList(1, 4, 6, 6), SUCCESS); // 4 * (6 + 6) - 1 = 47
		temp.put(Arrays.asList(1, 5, 5, 5), FAILURE);
		temp.put(Arrays.asList(1, 5, 5, 6), FAILURE);
		temp.put(Arrays.asList(1, 5, 6, 6), SUCCESS); // 5 + (1 + 6) * 6 = 47
		temp.put(Arrays.asList(1, 6, 6, 6), SUCCESS); // 1 + 6 + 6 * 6 = 43
		...
		temp.put(Arrays.asList(2, 2, 5, 5), FAILURE);
		temp.put(Arrays.asList(2, 2, 5, 6), FAILURE);
		temp.put(Arrays.asList(2, 2, 6, 6), FAILURE);
		temp.put(Arrays.asList(2, 3, 3, 3), FAILURE);
		temp.put(Arrays.asList(2, 3, 3, 4), FAILURE);
		temp.put(Arrays.asList(2, 3, 3, 5), SUCCESS); // 2 + 3 * 3 * 5 = 47
		temp.put(Arrays.asList(2, 3, 3, 6), FAILURE);
		temp.put(Arrays.asList(2, 3, 4, 4), FAILURE);
		temp.put(Arrays.asList(2, 3, 4, 5), SUCCESS); // 2 * 4 * 5 + 3 = 43
		temp.put(Arrays.asList(2, 3, 4, 6), FAILURE);
		temp.put(Arrays.asList(2, 3, 5, 5), SUCCESS); // 2 * 5 * 5 + 3 = 53
		temp.put(Arrays.asList(2, 3, 5, 6), SUCCESS); // (2 + 6) * 5 + 3 = 43
		temp.put(Arrays.asList(2, 3, 6, 6), FAILURE);
		temp.put(Arrays.asList(2, 4, 4, 4), FAILURE);
		temp.put(Arrays.asList(2, 4, 4, 5), FAILURE);
		temp.put(Arrays.asList(2, 4, 4, 6), FAILURE);
		temp.put(Arrays.asList(2, 4, 5, 5), SUCCESS); // 2 + (4 + 5) * 5 = 47
		temp.put(Arrays.asList(2, 4, 5, 6), SUCCESS); // 2 * 4 * 6 + 5 = 53
		temp.put(Arrays.asList(2, 4, 6, 6), FAILURE);
		temp.put(Arrays.asList(2, 5, 5, 5), FAILURE);
		temp.put(Arrays.asList(2, 5, 5, 6), SUCCESS); // (2 + 5) * 6 + 5 = 47
		temp.put(Arrays.asList(2, 5, 6, 6), SUCCESS); // 2 + 5 + 6 * 6 = 43
		temp.put(Arrays.asList(2, 6, 6, 6), FAILURE);
		temp.put(Arrays.asList(3, 3, 3, 3), FAILURE);
		temp.put(Arrays.asList(3, 3, 3, 4), FAILURE);
		temp.put(Arrays.asList(3, 3, 3, 5), FAILURE);
		temp.put(Arrays.asList(3, 3, 3, 6), FAILURE);
		temp.put(Arrays.asList(3, 3, 4, 4), FAILURE);
		temp.put(Arrays.asList(3, 3, 4, 5), FAILURE);
		temp.put(Arrays.asList(3, 3, 4, 6), FAILURE);
		temp.put(Arrays.asList(3, 3, 5, 5), SUCCESS); // 3 + (3 + 5) * 5 = 43
		temp.put(Arrays.asList(3, 3, 5, 6), FAILURE);
		temp.put(Arrays.asList(3, 3, 6, 6), FAILURE);
		temp.put(Arrays.asList(3, 4, 4, 4), FAILURE);
		temp.put(Arrays.asList(3, 4, 4, 5), SUCCESS); // 3 + (4 + 4) * 5 = 43
		temp.put(Arrays.asList(3, 4, 4, 6), SUCCESS); // 3 + 4 * (4 + 6) = 43
		temp.put(Arrays.asList(3, 4, 5, 5), SUCCESS); // 3 + 4 * (5 + 5) = 43
		temp.put(Arrays.asList(3, 4, 5, 6), SUCCESS); // 3 + 5 * (4 + 6) = 53
		temp.put(Arrays.asList(3, 4, 6, 6), SUCCESS); // 3 + 4 + 6 * 6 = 43
		temp.put(Arrays.asList(3, 5, 5, 5), SUCCESS); // 3 + 5 * (5 + 5) = 53
		temp.put(Arrays.asList(3, 5, 5, 6), SUCCESS); // (3 + 5) * 6 + 5 = 53
		temp.put(Arrays.asList(3, 5, 6, 6), FAILURE);
		temp.put(Arrays.asList(3, 6, 6, 6), FAILURE);
		temp.put(Arrays.asList(4, 4, 4, 4), FAILURE);
		temp.put(Arrays.asList(4, 4, 4, 5), FAILURE);
		temp.put(Arrays.asList(4, 4, 4, 6), FAILURE);
		temp.put(Arrays.asList(4, 4, 5, 5), FAILURE); 
		temp.put(Arrays.asList(4, 4, 5, 6), SUCCESS); // (4 + 4) * 6 + 5 = 53
		temp.put(Arrays.asList(4, 4, 6, 6), FAILURE);
		temp.put(Arrays.asList(4, 5, 5, 5), FAILURE);
		temp.put(Arrays.asList(4, 5, 5, 6), FAILURE);
		temp.put(Arrays.asList(4, 5, 6, 6), SUCCESS); // (6 + 6) * 4 + 5 = 53
		temp.put(Arrays.asList(4, 6, 6, 6), FAILURE);
		temp.put(Arrays.asList(5, 5, 5, 5), FAILURE);
		temp.put(Arrays.asList(5, 5, 5, 6), FAILURE);
		temp.put(Arrays.asList(5, 5, 6, 6), FAILURE);
		temp.put(Arrays.asList(5, 6, 6, 6), SUCCESS); // 5 + 6 + 6 * 6 = 47
		temp.put(Arrays.asList(6, 6, 6, 6), FAILURE);
		EXPECTED_RESULTS_04_VALUES = Collections.unmodifiableMap(temp);
	}

	private DataResultMapsForSpellLevel5() {
	}
}
