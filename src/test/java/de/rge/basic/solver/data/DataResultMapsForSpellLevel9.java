...
public class DataResultMapsForSpellLevel9 {
	...
	static {
		...
		temp.put(Arrays.asList(3, 4, 5, 5), SUCCESS); // 3 + 4 * 5 * 5 = 103
		...
		temp.put(Arrays.asList(3, 5, 6, 6), SUCCESS); // 3 * 6 * 6 - 5 = 103
		...
		temp.put(Arrays.asList(4, 4, 5, 6), SUCCESS); // 4 * 4 * 6 + 5 = 101
	...
	private DataResultMapsForSpellLevel9() {
	}
}
